...
class UserInfo(AbstractUser):
    ...
    blog = models.OneToOneField(
        to='Blog', to_field='id', null=True, on_delete=models.CASCADE)
...
class Article(models.Model):
    ...
    user = models.ForeignKey(
        verbose_name='Author', to='UserInfo', to_field='id', on_delete=models.CASCADE)
    blog = models.ForeignKey(
        to='Blog', to_field='id', on_delete=models.CASCADE)
    category = models.ForeignKey(
        to='Category', to_field='id', on_delete=models.CASCADE)
...
class Comment(models.Model):
    ...
    article = models.ForeignKey(verbose_name='For Article',
                                to='Article', to_field='id', on_delete=models.CASCADE)
...
class Article2Tag(models.Model):
    article = models.ForeignKey(
        verbose_name='Article', to='Article', to_field='id', on_delete=models.CASCADE)
...
class ArticleUpDown(models.Model):
    article = models.ForeignKey(
        to='Article', to_field='id', null=True, on_delete=models.CASCADE)
    user = models.ForeignKey(
